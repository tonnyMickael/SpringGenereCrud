...
public class Config {
     ...
     */
    public static final String [] placeHoldersController = {"[nameEntityMaj]","[nameEntity]","[idType]","[isAnyFieldNullOrEmpty]","[AutowiredchildEntity]","[RequestParamChildEntity]", "[AttributeChildEntity]", "[setChildEntity]","[supplementMethods]","[insidUpdateMethodInElse]"};
