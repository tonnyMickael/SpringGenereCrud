...
// (2): Do we want access the table child(person) from the table parent(region)
	...
	public ConfigORM2(String name_table_parent, String name_table_child, String assoc_parent_child,
	...
	public ConfigORM2 [] listORMConfig() {
		List<ConfigORM2> list = new ArrayList<>();
		
		// @OneToOne unidirectional
		list.add(new ConfigORM2("region", "person", "1-N", "1-1",true,false,"","2"));
		list.add(new ConfigORM2("person", "address", "1-1", "1-1",true,false,"","2"));
		...
		return list.toArray(new ConfigORM2[0]);
	}
}
